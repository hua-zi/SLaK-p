...
def main(args):
    ...
    # print('-----hhhhhhh--',args.distributed)
    # print(args)
...
if __name__ == '__main__':
    ...
    #         prob=args.mixup_prob, switch_prob=args.mixup_switch_prob, mode=args.mixup_mode,
    #         label_smoothing=args.smoothing, num_classes=args.nb_classes)
        # print('aaaaa',args.mixup,args.cutmix,args.cutmix_minmax,args.mixup_prob,args.mixup_switch_prob,args.mixup_mode,args.smoothing)
    ...
    # BatchNorm2D_pth = paddle.load('./mlp.pdparams')
    # for key in BatchNorm2D_pth:
    #     print(key,' | ', BatchNorm2D_pth[key].shape)
